...
shapefile='/projectnb/landsat/datasets/MODIS/h12v09/stacks_buf3/shapefiles/Produs_2008.shp'
directory='/projectnb/landsat/datasets/MODIS/h12v09/stacks_buf3'
example='/projectnb/landsat/datasets/MODIS/h12v09/stacks_buf3/example_img.gtif'
output1='/projectnb/landsat/datasets/MODIS/h12v09/stacks_buf3/Averages/2008/'
...
for stack in $(find $directory -maxdepth 2 -name '*L*stack'); do
    echo "Stack is $stack"
...
for img in $(find $output1 -name 'M*subset'); do
...
for img in $(find ./ -maxdepth 1 -name 'M*final.tif'); do
