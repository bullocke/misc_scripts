...
shapefile='/projectnb/landsat/users/bullocke/testing/CCDC_Visualization/California/shapefile.shp'
directory='/projectnb/landsat/users/ceholden/LC8_LE7/timeseries/p043r034/images'
example='/projectnb/landsat/users/ceholden/LC8_LE7/timeseries/p043r034/images/example_img'
output1='/projectnb/landsat/users/bullocke/testing/CCDC_Visualization/California/images_NoCir/'
...
for stack in $(find $directory -maxdepth 2 -name 'LC*_stackTMETM' ); do
    echo "Stack is $stack"
